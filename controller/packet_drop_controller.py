...
class PacketDropController(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        # This handles normal "Learning Switch" logic for non-blocked traffic
        msg = ev.msg
        ...
        # Install a flow to avoid packet_in next time for this destination
